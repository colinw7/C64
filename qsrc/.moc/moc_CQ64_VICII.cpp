...
QT_MOC_LITERAL(4, 32, 3), // "len"
QT_MOC_LITERAL(5, 36, 10), // "updateSlot"
QT_MOC_LITERAL(6, 47, 6), // "margin"
QT_MOC_LITERAL(7, 54, 5) // "scale"

    },
    "CQ64_VICII\0memChangedSlot\0\0addr\0len\0"
    "updateSlot\0margin\0scale"
};
...
void CQ64_VICII::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CQ64_VICII *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->memChangedSlot((*reinterpret_cast< ushort(*)>(_a[1])),(*reinterpret_cast< ushort(*)>(_a[2]))); break;
...
QT_INIT_METAOBJECT const QMetaObject CQ64_VICII::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_CQ64_VICII.data,
    qt_meta_data_CQ64_VICII,
    qt_static_metacall,
    nullptr,
    nullptr
} };
